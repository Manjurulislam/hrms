            ...
            <v-expansion-panel>
                ...
                <v-expansion-panel-text class="pt-4">
                    <v-row>
                        ...
                        <v-col cols="12" lg="3" md="6">
                            <label class="text-caption font-weight-medium mb-1 d-block">Employment Status</label>
                            <el-select
                                v-model="filters.emp_status"
                                clearable
                                placeholder="All"
                                style="width: 100%"
                            >
...
const filteredDepartments = computed(() => {
    if (!props.filters.company_id) return props.departments;
